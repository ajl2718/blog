...
author: "Alex Lee"
date: "2021-01-01"
categories: [python, webscraping, requests, open data]
image: html_snippet_chase.png
format:
  html:
    code-links:
      - text: Webscraping notebook
        icon: file-code
        href: https://github.com/saunteringcat/python_learning/blob/master/Intro_to_webscraping_010121.ipynb
---
...
![The Inspector is located under Tools and Web Developer](inspector_firefox2.png)
...
![Some cute dogs looking for a new home](dog_listing.png)
...
![The HTML snippet corresponding to the entry for 'Chase'](html_snippet_chase.png)
