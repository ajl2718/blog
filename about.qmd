...
My background is in maths and physics and I completed my PhD back in 2015. Since then I have worked in a range of data science roles. My main interests are in clinical data science, machine learning and statistics. I also enjoy occasionally tinkering with open data.
...
- [PhraseGeocoder](https://github.com/saunteringcat/loupe): a geocoding package built using Python and PostgreSQL for Australian street addresses, based on recent research on record linkage algorithms. 
